...
<head>
    ...
    <title>Informazioni PHP - ANDREA RAIMONDI</title>
    <style>
        body {
...
<body>
    <div class='header'>
        ...
        <p>Configurazione del server PHP per ANDREA RAIMONDI</p>
    </div>
    
    <div class='info-box'>
        <h2>📊 Dati Studente</h2>
        <p><strong>Nome:</strong> ANDREA RAIMONDI</p>
        <p><strong>Classe:</strong> 5CINF</p>
        <p><strong>Username:</strong> raimondi.andrea</p>
